      ...
      <div className="relative w-full max-w-md">
        <div className="bg-gray-800/40 backdrop-blur-xl border border-cyan-500/20 rounded-2xl p-8 shadow-2xl">
          <div className="text-center mb-8">
            ...
            <p className="text-gray-400">Acesse sua conta segura</p>
          </div>
          ...
          <div className="mt-6 pt-6 border-t border-gray-700">
            <div className="bg-gray-700/30 rounded-lg p-4">
              <p className="text-sm text-gray-400 mb-2">Contas de teste:</p>
              <p className="text-xs text-cyan-400">Admin: admin@vaultvision.com / admin123</p>
              <p className="text-xs text-cyan-400">Usuário: user@vaultvision.com / user123</p>
            </div>
          </div>
